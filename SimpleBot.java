...
//52.04 Дописать фразы в константы

class SimpleBot {

    final String[] COMMON_PHRASES = {
            "Нет ничего ценнее слов, сказанных к месту и ко времени.",
            "Порой молчание может сказать больше, нежели уйма словив.",
            "Перед тем как писать/говорить всегда лучше подумать.",
            "Веждивая и грамотная речь говорит о величии души.",
    ...
    final String[] ELUSIVE_ANSWERS = {
            ...
            "Может лучше поговорить о чем-то другом?",
    ...
    final Map<String, String> PATTERNS_FOR_ANALYSIS = new HashMap<>() {{
        ...
        final Map<String, String> ANSWERS_BY_PATTERNS = new HashMap<String, String>() {{
            ...
            put("whatdoyoulike", "Мне нравится думать что я не просто машина");
